...
public class LightBall extends Sprite {
    ...
    private void initShader() {
        String vertexShader = TSShaderUtil.loadFromAssetsFile("light_ball_vertex.glsl", TSApplication.getInstance().getResources());
        String fragmentShader = TSShaderUtil.loadFromAssetsFile("light_ball_frag.glsl", TSApplication.getInstance().getResources());
